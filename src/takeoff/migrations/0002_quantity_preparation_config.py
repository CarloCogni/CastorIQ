        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "contract_version",
                    models.CharField(
                        default="qty-prep-config-v1", max_length=64, verbose_name="Contract version"
                    ),
                ),
                (
                    "basis_rules",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["project", "-updated_at"], name="takeoff_qua_project_a87401_idx"
                    ),
                    models.Index(
                        fields=["project", "status"], name="takeoff_qua_project_6888ed_idx"
                    ),
                ],
            },
        ),
