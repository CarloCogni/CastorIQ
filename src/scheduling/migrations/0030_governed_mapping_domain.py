    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dimension_key",
                    models.CharField(db_index=True, max_length=64, verbose_name="Dimension Key"),
                ),
                ...
                (
                    "structure_type",
                    models.CharField(
                        choices=[("flat", "Flat"), ("hierarchical", "Hierarchical")],
                        default="flat",
                        max_length=16,
                ...
                (
                    "cardinality",
                    models.CharField(
                        choices=[("single", "Single-valued"), ("multiple", "Multi-valued")],
                        default="single",
                        max_length=16,
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("imported_authoritative", "Imported authoritative"),
                            ("governed_source", "Governed source"),
                            ("mixed", "Mixed"),
                        ],
                ...
                (
                    "governance_metadata",
                    models.JSONField(blank=True, default=dict, verbose_name="Governance Metadata"),
                ),
                (
                    "activated_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Activated At"),
                ),
                (
                    "superseded_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="castor_scheduling.analyticaldimension",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "path",
                    models.CharField(
                        blank=True, db_index=True, max_length=512, verbose_name="Path"
                    ),
                ),
                ...
                (
                    "external_id",
                    models.CharField(
                        blank=True, db_index=True, max_length=128, verbose_name="External ID"
                    ),
                ),
                (
                    "identity_status",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="castor_scheduling.analyticaldimensionvalue",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "effective_from",
                    models.DateField(blank=True, null=True, verbose_name="Effective From"),
                ),
                (
                    "effective_to",
                ...
                (
                    "coverage_summary",
                    models.JSONField(blank=True, default=dict, verbose_name="Coverage Summary"),
                ),
                (
                    "conflict_summary",
                    models.JSONField(blank=True, default=dict, verbose_name="Conflict Summary"),
                ),
                (
                    "is_selected_for_analysis",
                    models.BooleanField(
                ...
                (
                    "inherit_wbs_to_tasks",
                    models.BooleanField(
                        default=True, verbose_name="Inherit WBS mappings to descendant Tasks"
                    ),
                ),
                ("metadata", models.JSONField(blank=True, default=dict, verbose_name="Metadata")),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="castor_scheduling.analyticalmappingset",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "entity_global_id",
                    models.CharField(
                        blank=True, db_index=True, max_length=64, verbose_name="IFC Entity GlobalId"
                    ),
                ),
                (
                    "mapping_method",
                ...
                (
                    "provenance",
                    models.JSONField(blank=True, default=dict, verbose_name="Provenance"),
                ),
                (
                    "reviewed_at",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="castor_scheduling.analyticalmappingassignment",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("dimension_activated", "Dimension activated"),
                            ("dimension_superseded", "Dimension superseded"),
                            ("value_created", "Value created"),
                            ("value_retired", "Value retired"),
                            ("mapping_set_created", "Mapping set created"),
                            ("mapping_set_submitted", "Mapping set submitted"),
                            ("mapping_set_approved", "Mapping set approved"),
                            ("mapping_set_activated", "Mapping set activated"),
                            ("mapping_set_rejected", "Mapping set rejected"),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["project", "dimension_key", "status"], name="castor_sche_project_641616_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="analyticaldimension",
            index=models.Index(
                fields=["project", "dimension_type"], name="castor_sche_project_d5c5bc_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["dimension", "status"], name="castor_sche_dimensi_6d9bbf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="analyticaldimensionvalue",
        ...
        migrations.AddIndex(
            model_name="analyticalmappingset",
            index=models.Index(
                fields=["dimension", "status"], name="castor_sche_dimensi_275eb8_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="analyticalmappingset",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["mapping_set", "governance_status"], name="castor_sche_mapping_79ce83_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="analyticalmappingassignment",
            index=models.Index(
                fields=["task", "governance_status"], name="castor_sche_task_id_d963b5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="analyticalmappingassignment",
            index=models.Index(
                fields=["wbs_node", "governance_status"], name="castor_sche_wbs_nod_c0d690_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="analyticalmappingassignment",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["project", "event_type"], name="castor_sche_project_873939_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="mappinggovernanceevent",
            index=models.Index(
                fields=["project", "created_at"], name="castor_sche_project_59d4ac_idx"
            ),
        ),
    ]
