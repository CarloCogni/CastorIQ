...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("castor_scheduling", "0001_initial"),
    ]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "confidence_at_time",
                    models.FloatField(
                        blank=True, null=True, verbose_name="Confidence score at suggestion time"
                    ),
                ),
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["task", "accepted"], name="islam_sched_task_id_bec3ed_idx")
                ],
            },
        ),
        migrations.CreateModel(
