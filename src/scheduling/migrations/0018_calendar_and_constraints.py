...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ("castor_scheduling", "0017_p6_models"),
    ]
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "p6_calendar_id",
                    models.CharField(
                        db_index=True, max_length=50, verbose_name="P6 Calendar ObjectId"
                    ),
                ),
                ...
                (
                    "is_pending",
                    models.BooleanField(db_index=True, default=True, verbose_name="Pending"),
                ),
                (
                    "project",
                    models.ForeignKey(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["project", "is_pending"], name="islam_sched_project_f68a20_idx"
                    ),
                    models.Index(
                        fields=["project", "p6_calendar_id"], name="islam_sched_project_991a7e_idx"
                    ),
                ],
            },
        ),
