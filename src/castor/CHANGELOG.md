# castor Module — CHANGELOG

---

### [2026-05-14] castor/scheduling/models.py — TaskEntityBinding
...
### [2026-05-14] castor/scheduling/migrations/0003_task_entity_binding.py
- Action: Generated by makemigrations
- What it does: Creates the `castor_scheduling_taskentitybinding` table
...
### [2026-05-14] castor/scheduling/templates/scheduling/tabs/mapping.html
...
### [2026-05-14] castor/scheduling/views.py — Review views + helpers
...
### [2026-05-14] castor/urls.py — Link Review URL patterns
...
### [2026-05-14] castor/scheduling/templates/scheduling/components/link_review_summary.html
- Action: Created
...
### [2026-05-14] castor/scheduling/templates/scheduling/components/link_review_row.html
- Action: Created
...
### [2026-05-14] castor/scheduling/templates/scheduling/components/binding_search.html
- Action: Created
...
### [2026-05-14] castor/scheduling/templates/scheduling/tabs/link_review.html
- Action: Created
...
### [2026-05-14] castor/scheduling/templates/scheduling/panel.html
...
### [2026-05-14] castor/scheduling/services/autolink.py — Layer 3 spatial refinement
- Action: Modified
...
### [2026-05-14] castor/scheduling/services/autolink.py
- Action: Created
...
### [2026-05-14] castor/scheduling/templates/scheduling/components/autolink_summary.html
- Action: Created
...
### [2026-05-14] castor/scheduling/views.py — AutoLinkView + ScheduleView
...
### [2026-05-14] castor/urls.py — schedule_link_smart
...
### [2026-05-14] castor/scheduling/templates/scheduling/tabs/attach.html
...
### [2026-05-14] castor/scheduling/views.py — MappingSubmitView
...
### [2026-05-15] castor/ifc_insights/services/metrics.py
...
### [2026-05-15] castor/ifc_insights/views.py
...
- Depends on: IFCEntity, IFCFile, Level, TaskEntityBinding (scheduling), levels.py services, 5 new partial templates

### [2026-05-15] castor/urls.py
...
### [2026-05-15] castor/ifc_insights/templates/ifc_insights/panel.html
...
- What it does: Removed `{% if activity_table %}` Activity Schedule Summary card and `{% if has_cost_data %}` Cost Summary card (both moved to IFC Issues tab). Added conditional `missing_4d` / `missing_5d` count lines under each ring (red if > 0, green if 0). Added "View Issues →" outline-danger button linking to `castor:ifc_issues`. Updated help modal to remove stale section descriptions and add View Issues reference.
- Why it was necessary: Separate readiness summary (panel.html) from element-level audit (IFC Issues tab).
- Depends on: missing_4d, missing_5d context vars from entity_metrics, castor:ifc_issues URL

### [2026-05-15] castor/templates/castor/panel.html
- Action: Modified — added IFC Issues tab nav item, dispatch branch, badge fetch script
- What it does: New nav-link "IFC Issues" between IFC Insights and Levels, with `id="ifc-issues-nav-badge"` span (hidden, bg-danger). Dispatch branch `{% elif castor_subtab == 'ifc_issues' %}` includes issues_panel.html. Inline `<script>` fetches `issues_count` JSON on every page render and shows the badge when total > 0.
...
### [2026-05-15] castor/ifc_insights/templates/ifc_insights/issues_panel.html
- Action: Created
...
### [2026-05-15] castor/ifc_insights/templates/ifc_insights/components/issues_missing_activity.html
- Action: Created
...
### [2026-05-15] castor/ifc_insights/templates/ifc_insights/components/issues_missing_cost.html
- Action: Created
...
### [2026-05-15] castor/ifc_insights/templates/ifc_insights/components/issues_activity_audit.html
- Action: Created
...
### [2026-05-15] castor/ifc_insights/templates/ifc_insights/components/issues_levels_health.html
- Action: Created
...
- Depends on: IssuesLevelsHealthView, levels_url (castor:levels)

### [2026-05-15] castor/ifc_insights/templates/ifc_insights/components/issues_help_modal.html
- Action: Created
...
### [2026-05-14] castor/ifc_insights/services/levels.py
- Action: Rewritten
...
### [2026-05-14] castor/ifc_insights/templates/ifc_insights/components/storey_registry_body.html
- Action: Created
...
### [2026-05-14] castor/ifc_insights/templates/ifc_insights/components/storey_row.html
- Action: Created
- What it does: Two-state `<tr id="storey-row-{safe_id}">`. Linked state (Level imported): shows linked_level.name (editable inline), linked_level.z_elevation (editable), element_count, in_schedule badge, "Imported" badge + pencil edit + x-circle unlink buttons. Edit save calls `storeyEditSave(safeId, url)` which POSTs with refresh_registry=1. Unlink uses hx-delete with `?storey_gid=<gid>&refresh_registry=1`. Unlinked state: shows IFC name/z in muted italic, Import button posting to level_add with name + z_elevation + ifc_storey_global_id in hx-vals. safe_id = global_id lowercased with $ removed.
...
### [2026-05-14] castor/ifc_insights/templates/ifc_insights/components/level_suggest_results.html
...
### [2026-05-14] castor/ifc_insights/templates/ifc_insights/components/levels_help_modal.html
- Action: Updated — rewritten for 5-section redesign
- What it does: Describes all five panel sections (Reference Points, IFC Storey Registry, Missing Level Hints, Manual Levels, Apply to IFC). Typical workflow as numbered steps. Updated caveats: unlinking removes Level record only (not IFC file), In Schedule is text-match hint only.
...
### [2026-05-14] castor/__init__.py
- Action: Created
- What it does: Makes `castor` a Python package recognised by Django
- Why it was necessary: Required for Django app discovery and template loading
- Depends on: Nothing

### [2026-05-14] castor/apps.py
- Action: Created
- What it does: `CastorConfig` AppConfig — registers the root `castor` app so its `templates/` dir is found
- Why it was necessary: Root app must be in INSTALLED_APPS for `castor/panel.html` to be discoverable
- Depends on: django.apps.AppConfig

### [2026-05-14] castor/urls.py
- Action: Created
- What it does: Root URL dispatcher with `app_name = "castor"`. All 3 sub-apps' URLs registered here under the `castor:` namespace.
- Why it was necessary: Single mount point for `path("castor/", include("castor.urls"))` in config/urls.py
- Depends on: castor.ifc_viewer.views, castor.scheduling.views, castor.ifc_insights.views

### [2026-05-14] castor/README.md
- Action: Created
...
### [2026-05-14] castor/frontend/vendor/.gitkeep
- Action: Created
...
### [2026-05-14] castor/templates/castor/panel.html
- Action: Created
- What it does: Master sub-tab dispatcher included in project_detail.html when `active_tab == 'castor'`. Shows sub-tab nav (3D Viewer / TimeLiner / IFC Insights) and includes the right partial based on `castor_subtab`.
- Why it was necessary: The single `{% include %}` added to project_detail.html must dispatch to all three sub-apps
- Depends on: castor.ifc_viewer.templates, castor.scheduling.templates, castor.ifc_insights.templates

---

## App: ifc_insights

### [2026-05-14] castor/ifc_insights/__init__.py
- Action: Created
- What it does: Package marker
- Why it was necessary: Required for Python module resolution
- Depends on: Nothing

### [2026-05-14] castor/ifc_insights/apps.py
- Action: Created
- What it does: `IfcInsightsConfig` with `label = "castor_ifc_insights"` to avoid collision with any future `ifc_insights` app
- Why it was necessary: Custom label prevents AppRegistryNotReady errors
- Depends on: django.apps.AppConfig

### [2026-05-14] castor/ifc_insights/models.py
- Action: Created
...
### [2026-05-14] castor/ifc_insights/services/__init__.py
- Action: Created
- What it does: Package marker for services sub-package
- Depends on: Nothing

### [2026-05-14] castor/ifc_insights/services/checks.py
- Action: Created
...
### [2026-05-14] castor/ifc_insights/templates/ifc_insights/panel.html
- Action: Created
...
- Depends on: ifc_insights/components/*.html, {% url 'castor:insights_rerun' %}

### [2026-05-14] castor/ifc_insights/templates/ifc_insights/components/summary_cards.html
- Action: Created
...
### [2026-05-14] castor/ifc_insights/templates/ifc_insights/components/issues_table.html
- Action: Created
- What it does: Filterable table of all issues. JS severity toggle buttons. Color-coded badges.
- Depends on: check_results context var

### [2026-05-14] castor/ifc_insights/templates/ifc_insights/components/export_btn.html
- Action: Created
- What it does: Renders Export CSV link when there are issues to download
- Depends on: {% url 'castor:insights_export' %}, check_results context var

---

## App: scheduling

### [2026-05-14] castor/scheduling/__init__.py
- Action: Created
- Depends on: Nothing

### [2026-05-14] castor/scheduling/apps.py
- Action: Created
- What it does: `SchedulingConfig` with `label = "castor_scheduling"`
- Depends on: django.apps.AppConfig

### [2026-05-14] castor/scheduling/models.py
- Action: Created
...
### [2026-05-14] castor/scheduling/services/__init__.py
- Action: Created
- Depends on: Nothing

### [2026-05-14] castor/scheduling/services/excel_parser.py
- Action: Created
...
### [2026-05-14] castor/scheduling/services/xer_parser.py
- Action: Created
...
### [2026-05-14] castor/scheduling/services/msp_parser.py
- Action: Created
...
### [2026-05-14] castor/scheduling/services/linker.py
- Action: Created
...
### [2026-05-14] castor/scheduling/services/validator.py
- Action: Created
...
### [2026-05-14] castor/scheduling/views.py
- Action: Created
...
### [2026-05-14] castor/scheduling/templates/scheduling/tabs/data_sources.html
- Action: Created
...
- Depends on: {% url 'castor:schedule_upload' %}, scheduling/components/task_list.html
...
- Depends on: {% url 'castor:schedule_link_auto' %}, {% url 'castor:schedule_link_param' %}

### [2026-05-14] castor/scheduling/templates/scheduling/tabs/gantt.html
- Action: Created
...
- Depends on: {% url 'castor:gantt_data' %}, scheduling/components/gantt_chart.html

### [2026-05-14] castor/scheduling/templates/scheduling/tabs/simulate.html
- Action: Created
...
- Depends on: {% url 'castor:gantt_data' %}

### [2026-05-14] castor/scheduling/templates/scheduling/components/task_list.html
- Action: Created
...
- Depends on: {% url 'castor:schedule_save' %}, {% url 'castor:task_delete' %}

### [2026-05-14] castor/scheduling/templates/scheduling/components/gantt_chart.html
- Action: Created
...
### [2026-05-14] castor/ifc_viewer/__init__.py
- Action: Created
- Depends on: Nothing

### [2026-05-14] castor/ifc_viewer/apps.py
- Action: Created
- What it does: `IfcViewerConfig` with `label = "castor_ifc_viewer"`
- Depends on: django.apps.AppConfig

### [2026-05-14] castor/ifc_viewer/models.py
- Action: Created
- What it does: Empty — viewer reads IFCFile from the project at runtime
- Depends on: Nothing

### [2026-05-14] castor/ifc_viewer/views.py
- Action: Created
- What it does: `ViewerView` (ProjectTabMixin, active_tab="castor", castor_subtab="viewer"). Passes `ifc_file_url` and `viewer_ifc_file` to template.
- Depends on: core.mixins.ProjectTabMixin, ifc_processor.models.IFCFile

### [2026-05-14] castor/ifc_viewer/templates/ifc_viewer/viewer.html
- Action: Created
...
### castor/scheduling/migrations/0002_alter_task_source_linkfeedback_mappingprofile.py
...
### castor/scheduling/templates/scheduling/tabs/mapping.html
- Action: Created
...
### castor/scheduling/templates/scheduling/components/validation_table.html
- Action: Created
- What it does: Wrapping table for embedding match results. Iterates `feedbacks` and `{% include %}`s `validation_row.html` for each.

### castor/scheduling/templates/scheduling/components/validation_row.html
- Action: Created
...
### castor/scheduling/components/link_search.html
- Action: Created
...
### castor/scheduling/templates/scheduling/tabs/attach.html
...
### castor/scheduling/templates/scheduling/tabs/data_sources.html
...
### castor/ifc_viewer/templates/ifc_viewer/viewer.html
...
### castor/frontend/vendor/three/build/three.module.js
...
### castor/frontend/vendor/thatopen-fragments/dist/index.min.mjs
...
### castor/frontend/vendor/web-ifc/
...
### castor/ifc_viewer/templates/ifc_viewer/viewer.html (importmap + WASM path fix)
...
### castor/frontend/vendor/web-ifc/web-ifc-api.js
...
### castor/ifc_insights/templates/ifc_insights/panel.html
- Action: Redesigned — full replacement of the QA/QC-only panel with the new Insights dashboard:
  - Engine selector toggle (Castor / Legacy) persisted in localStorage
...
### castor/ifc_insights/templates/ifc_insights/components/breakdown_card.html
- Action: Created
...
- Action: Modified — replaced empty placeholder with `Level` model
- `Level(UUIDModel)` — project FK, name, z_elevation (FloatField), ifc_storey_global_id (nullable CharField), source (TextChoices: ifc/suggested/manual), created_at (auto). Ordered by z_elevation. Indexed on project.
- Depends on: core.models.UUIDModel, environments.models.Project

### castor/ifc_insights/migrations/0001_initial.py
- Action: Generated via `makemigrations castor_ifc_insights` — applied successfully
...
- Depends on: ifcopenshell (already in Castor), ifc_processor.models.IFCEntity, .models.Level

### castor/ifc_insights/views.py
- Action: Modified — added imports for Level, levels service, and 6 new view classes:
  ...
  - `LevelAddView(ProjectAccessMixin, View)` — HTMX POST; validates name + z_elevation; creates `Level`; returns `level_row.html` with success toast
...
- Depends on: core.http.toast_response, core.http.trigger_toast, .models.Level, .services.levels
...
### castor/templates/castor/panel.html
- Action: Modified — added "Levels" nav item (bi-layers icon) and `{% elif castor_subtab == 'levels' %}` dispatcher branch

### castor/ifc_insights/templates/ifc_insights/levels.html
- Action: Created
...
### castor/ifc_insights/templates/ifc_insights/components/level_row.html
- Action: Created
...
- Depends on: `{% url 'castor:level_edit' %}`, `{% url 'castor:level_delete' %}`

### castor/ifc_insights/templates/ifc_insights/components/level_suggest_results.html
- Action: Created
...
- Depends on: `{% url 'castor:level_add' %}`

### castor/ifc_insights/templates/ifc_insights/components/levels_help_modal.html
- Action: Created
...
### castor/ifc_viewer/services/__init__.py
...
- `BuildSequenceView(ProjectAccessMixin, View)` — GET `/viewer/build_sequence/`; groups IFCEntity by spatial_container; orders by Level Z (fallback: alphabetical); returns JSON `{levels: [{level_name, z_elevation, entity_global_ids}]}`
...
### castor/ifc_viewer/templates/ifc_viewer/components/gap_analysis_panel.html
- Action: Created
...
- Depends on: `{% url 'castor:viewer_gap_analysis' %}`, `highlightEntities` (window global from viewer.html module script)

### castor/ifc_viewer/templates/ifc_insights/components/simulator_help_modal.html
- Action: Created
...
### castor/scheduling/migrations/0005_task_cost.py
- Action: Generated by `makemigrations castor_scheduling` — NOT yet applied
...
### castor/scheduling/views.py — TaskSaveView
...
### castor/scheduling/migrations/0004_task_actual_end_task_actual_start.py
- Action: Generated by `makemigrations castor_scheduling` — NOT yet applied (migrate not run)
...
### castor/scheduling/templates/scheduling/components/task_list.html
...
### castor/ifc_insights/templates/ifc_insights/issues_panel.html
...
### castor/ifc_insights/templates/ifc_insights/components/issues_help_modal.html
