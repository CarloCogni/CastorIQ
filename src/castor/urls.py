# castor/urls.py
"""Root URL dispatcher for the castor 4D Insights module.

Mounted at /castor/ by config/urls.py.
All three sub-apps share the 'castor' namespace.
"""

from django.urls import path

from castor.ifc_insights import views as insights_views
from castor.ifc_viewer import views as viewer_views
from castor.intelligence import views as intelligence_views
from castor.scheduling import views as scheduling_views
