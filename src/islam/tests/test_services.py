# islam/tests/test_services.py
"""Tests for islam scheduling services: CPM, EVM, stage detection, layer-0."""
...
class CriticalPathTests(TestCase):
    ...
    def _cpm(self):
        from islam.scheduling.services.critical_path import compute_critical_path
...
class EVMServiceTests(TestCase):
    ...
    def _evm(self, as_of=None):
        from islam.scheduling.services.evm import compute_evm
    ...
    def test_ac_is_1_05_times_ev(self):
        make_task(
            self.project,
            start_date=date(2025, 1, 1),
            end_date=date(2025, 1, 10),
        ...
        result = self._evm(as_of=date(2025, 2, 1))
        self.assertAlmostEqual(result["ac"], result["ev"] * 1.05, places=2)
...
class StageDetectionTests(TestCase):
    ...
    def test_structure_stage_from_column(self):
        from islam.scheduling.services.autolink import detect_task_stage
    ...
    def test_sub_stage_concrete(self):
        from islam.scheduling.services.autolink import detect_task_sub_stage
...
class AutodetectStagesTests(TestCase):
    ...
    def test_sets_stage_from_task_name(self):
        ...
        from islam.scheduling.services.autolink import autodetect_stages
...
class LayerZeroTests(TestCase):
    ...
    def test_non_physical_keyword_in_name(self):
        from islam.scheduling.services.autolink import _is_non_physical_auto
    ...
    def test_locked_physical_not_reclassified(self):
        ...
        from islam.scheduling.services.autolink import _run_layer0
