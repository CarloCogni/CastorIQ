# islam/tests/test_views.py
"""HTTP-level tests for islam scheduling views."""
...
class ScheduleUploadTests(TestCase):
    ...
    def setUp(self):
        ...
        self.url = reverse("islam:schedule_upload", kwargs={"pk": self.project.pk})
...
class ScheduleSaveTests(TestCase):
    ...
    def setUp(self):
        ...
        self.project = make_project(owner=self.user)
        _login(self.client, self.user)
        self.url = reverse("islam:schedule_save", kwargs={"pk": self.project.pk})
...
class GanttDataTests(TestCase):
    ...
    def setUp(self):
        ...
        self.project = make_project(owner=self.user)
        _login(self.client, self.user)
        self.url = reverse("islam:gantt_data", kwargs={"pk": self.project.pk})
...
class CriticalPathViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.project = make_project(owner=self.user)
        _login(self.client, self.user)
        self.url = reverse("islam:critical_path", kwargs={"pk": self.project.pk})
...
class EVMDataTests(TestCase):
    ...
    def setUp(self):
        ...
        self.project = make_project(owner=self.user)
        _login(self.client, self.user)
        self.url = reverse("islam:evm_data", kwargs={"pk": self.project.pk})
...
class LookaheadDataTests(TestCase):
    ...
    def setUp(self):
        ...
        self.project = make_project(owner=self.user)
        _login(self.client, self.user)
        self.url = reverse("islam:lookahead_data", kwargs={"pk": self.project.pk})
...
class ScheduleViewTests(TestCase):
    ...
    def setUp(self):
        ...
        self.project = make_project(owner=self.user)
        _login(self.client, self.user)
        self.url = reverse("islam:schedule", kwargs={"pk": self.project.pk})
