...
class XerParserTests(TestCase):
    def _parse(self, **kw):
        from islam.scheduling.services.xer_parser import parse_xer
...
class P6XmlParserTests(TestCase):
    def _parse(self, **kw):
        from islam.scheduling.services.msp_parser import parse_msp
...
class ExcelParserTests(TestCase):
    def test_excel_parses_headers(self):
        ...
        from islam.scheduling.services.excel_parser import parse_excel
...
class ColumnMapperTests(TestCase):
    def test_parse_predecessor_string_multi(self):
        ...
        from islam.scheduling.services.column_mapper import parse_predecessor_string
    ...
    def test_cost_parsing_currency(self):
        ...
        from islam.scheduling.services.column_mapper import _parse_cost
