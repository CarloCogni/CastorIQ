# islam/intelligence/service.py
"""ProjectIntelligenceService — natural-language Q&A over the project schedule.

Pipeline:
  1. Embed the user's question.
  2. Retrieve top-k tasks by cosine similarity (IslamTaskEmbedding).
...
from islam.intelligence.embedder import ScheduleEmbedder, _task_text
from islam.scheduling.models import IslamTaskEmbedding
...
class ProjectIntelligenceService:
    ...
    def _ensure_coverage(self) -> int:
        ...
        coverage = IslamTaskEmbedding.objects.filter(task__project=self.project).count()
    ...
    def ask(self, question: str) -> dict:
        ...
        embeddings = (
            IslamTaskEmbedding.objects.filter(task__project=self.project)
