# islam/scheduling/tests/test_csv_pct_complete.py
...
from islam.scheduling.services.column_mapper import _parse_pct, apply_mapping
from islam.scheduling.services.evm import _earned_pct_at, compute_evm
