# islam/scheduling/tests/test_comprehension.py
...
from islam.scheduling.services.comprehension import (
...
def test_build_comprehension_with_tasks_returns_valid_structure():
    ...
    with patch("islam.scheduling.services.comprehension.get_llm") as mock_llm:
...
def test_build_comprehension_saves_to_db():
    ...
    from islam.scheduling.models import ProjectComprehension
