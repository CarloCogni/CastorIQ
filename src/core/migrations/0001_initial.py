        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "message",
                    models.TextField(
                        help_text="Short error description", verbose_name="Error Message"
                    ),
                ),
                (
                    "exception_type",
                ...
                (
                    "stacktrace",
                    models.TextField(
                        help_text="Full Python stacktrace", verbose_name="Stack Trace"
                    ),
                ),
                ...
                (
                    "view_name",
                    models.CharField(
                        blank=True, db_index=True, max_length=255, verbose_name="View Name"
                    ),
                ),
                (
                    "user_agent",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["-created_at", "severity"], name="core_errorl_created_bce940_idx"
                    ),
                    models.Index(
                        fields=["is_resolved", "-created_at"], name="core_errorl_is_reso_8d538a_idx"
                    ),
                    models.Index(
                        fields=["exception_type", "-created_at"],
                        name="core_errorl_excepti_3ba3ac_idx",
                    ),
                    models.Index(
                        fields=["view_name", "-created_at"], name="core_errorl_view_na_1f8f69_idx"
                    ),
                ],
            },
        ),
