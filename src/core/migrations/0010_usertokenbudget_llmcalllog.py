    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_reset_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Last Reset"),
                ),
                (
                    "hard_blocked",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "purpose",
                    models.CharField(
                        choices=[("ask", "Ask"), ("modify", "Modify")], db_index=True, max_length=10
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "-created_at"], name="core_llmcal_user_id_815b1a_idx"
                    ),
                    models.Index(
                        fields=["provider", "-created_at"], name="core_llmcal_provide_1ada39_idx"
                    ),
                ],
            },
        ),
